...
export const metadata = {
  title: { default: "Burbli", template: "%s • Burbli" },
  description:
    "Neighbourhood jobs & recommendations. Share what you paid and who did the work. Costs optional.",
  metadataBase: new URL("https://burbli.vercel.app"),
  openGraph: {
    title: "Burbli",
    description:
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 -mt-1">
                  Neighbourhood jobs & recommendations
                </p>
              </div>
            </div>
